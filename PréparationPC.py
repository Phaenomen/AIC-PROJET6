...
def registryKeys():
    ...
    try: # Permet de tester le code
        ...
        print(" --> Le message d'accueil n'a pas été paramètré")  # Affiche ce message
    else: # Si le code s'execute bien
        print(" --> Le message d'accueil a été paramètré") # Affiche ce message
    ...
    try: # Permet de tester le code
        ...
        print(" --> La corbeille n'a pas été rajouté dans les péréphiques")  # Affiche ce message
    else: # Si le code s'execute bien
...
def hibernate() :
    try: # Permet de tester le code
        ...
        print(" --> La mise en veille prolongée n'a pas été désactivée.") # Affiche ce message
    else: # Si le code s'execute bien
...
def runNinite() :
    ...
    try: # Permet de tester le code
        ...
        print(" --> Ninite n'a pas pu terminé correctement.") # Affiche ce message
    else: # Si le code s'execute bien
...
def windowsUpdate() :
    try: # Permet de tester le code
        ...
        print(" --> Les MAJ Windows n'ont pas été lancées.") # Affiche ce message
    else: # Si le code s'execute bien
...
def changeDns() :
    try: # Permet de tester le code
        ...
        print(" --> Les DNS n'ont été changés.") # Affiche ce message
    else: # Si le code s'execute bien
...
def computerName() :
    try: # Permet de tester le code
        ...
        print(" --> La modification du nom de poste n'a pas été effectué") # Affiche ce message
    else: # Si le code s'execute bien
...
def planReboot(timer) :
    try: # Permet de tester le code
        ...
        print(" --> L'ordinateur ne va pas redémarrer") # Affiche ce message
    else: # Si le code s'execute bien
        print(" --> L'ordinateur va redémarrer dans " + str(timer) + ' secondes.') # Affiche ce message
